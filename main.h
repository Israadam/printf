...
/* number.c module */
char *convert(long int num, int base, int flags;params_t *paramas);
in print_unsigned(va_list ap params_t *params);
...
char *get_width(char *s, params_t *paramms, va_list ap);
...
int print_fro_to(char *start, char *stop, char *except);
